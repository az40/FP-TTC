...
def flow_wrap(feature, flow, mask=False, padding_mode='zeros'):
...
def forward_backward_consistency_check(fwd_flow, bwd_flow,
    ...
    warped_bwd_flow = flow_wrap(bwd_flow, fwd_flow)  # [B, 2, H, W]
    warped_fwd_flow = flow_wrap(fwd_flow, bwd_flow)  # [B, 2, H, W]

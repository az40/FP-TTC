...
class FeatureTransformerS(nn.Module):
    def __init__(self,
                 num_layers=6,
                 d_model=128,
                 nhead=1,
        ...
        super(FeatureTransformerS, self).__init__()

        self.d_model = d_model
        self.nhead = nhead

        self.layers = TransformerBlock(d_model=d_model,
                             nhead=nhead,
                             ffn_dim_expansion=ffn_dim_expansion,
                             )
    ...
    def forward(self, feature0, feature1,
        ...
        agg_feat = self.layers(feature0, feature1,
                            height=h,
                            width=w,
                            attn_type=attn_type,
                            with_shift=False,
